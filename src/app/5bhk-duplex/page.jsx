...
export const metadata = {
  alternates: { canonical: '/5bhk-duplex' },
...
export default function FiveBhkDuplexPage() {
  ...
  return (
    <main>
      ...
      <SchemaMarkup pageName="5 BHK & Duplex Homes" pageUrl="/5bhk-duplex" />
      ...
      <div className="pillar-content" style={{ padding: '4rem 0' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '3rem' }}>
          ...
          <article className="main-content">
            ...
            <p>
              In the premium segment of the <Link href="/pune-west-real-estate-market">Pune West Real Estate Market</Link>, size is only half the equation; the other half is architectural philosophy. The 5 BHK duplex residences and sky villas at <Link href="/">Malpani M SoulStrings</Link> are built to define structural privilege. Spanning two levels of design, these estates separate private rest quarters from grand social zones.
            </p>
            <p>
              Situated on the prestigious <Link href="/location">Baner Pashan Link Road</Link>, this project protects its residents from urban noise via the adjacent Pashan hills, while staying situated minutes away from Balewadi High Street, Aundh, and Hinjewadi Phase 1 offices.
            </p>
            <p>
