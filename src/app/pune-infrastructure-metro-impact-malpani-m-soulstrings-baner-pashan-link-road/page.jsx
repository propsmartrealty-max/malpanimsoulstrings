...
export const metadata = {
  alternates: { canonical: '/pune-infrastructure-metro-impact-malpani-m-soulstrings-baner-pashan-link-road' },
...
export default function PuneInfrastructurePage() {
  ...
  return (
    <main>
      ...
      <SchemaMarkup pageName="Metro Infrastructure Impact" pageUrl="/pune-infrastructure-metro-impact-malpani-m-soulstrings-baner-pashan-link-road" />
