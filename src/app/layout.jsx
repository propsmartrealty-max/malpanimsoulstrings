...
export const metadata = {
  ...
  keywords: [
    ...
    'Malpani M Soulstrings reviews',
    'Malpani M Soulstrings Baner price',
    'Malpani M Soulstrings RERA number',
    'Malpani M Soulstrings construction update',
    'Malpani M Soulstrings contact number',
    '3 BHK price in Malpani Soulstrings Baner',
    'Book 4 BHK Malpani M Soulstrings',
    'Malpani Estates new launch Baner',
