...
export const metadata = {
  ...
  keywords: [
    ...
    'Malpani M SoulStrings NRI',
    'repatriation of real estate funds India',
    'luxury real estate ROI Pune',
    'FEMA real estate guidelines',
    'NRI Investment Luxury Property Pune',
...
export default function NRIInvestmentPage() {
  ...
  return (
    <main>
      ...
      <SchemaMarkup pageName="NRI Investment Guide" pageUrl="/nri-investment-malpani-m-soulstrings-baner-pashan-link-road" />
      ...
      <div className="pillar-content" style={{ padding: '4rem 0' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '3rem' }}>
          ...
          <aside className="sidebar">
            ...
            <div className="loc-card" style={{ padding: '1.5rem', borderRadius: '12px', position: 'sticky', top: '560px' }}>
