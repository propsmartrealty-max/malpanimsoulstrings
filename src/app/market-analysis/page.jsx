...
export default function MarketAnalysisPage() {
  return (
    <main>
          ...
          <aside className="sidebar">
            <div className="loc-card" style={{ padding: '1.5rem', borderRadius: '12px', position: 'sticky', top: '100px' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem' }}><Link href="/aundh" style={{ color: 'var(--color-text)', textDecoration: 'none' }}>Aundh Upgrade Guide</Link></li>
                <li style={{ marginBottom: '1rem' }}><Link href="/shivajinagar" style={{ color: 'var(--color-text)', textDecoration: 'none' }}>Shivajinagar Retreat Guide</Link></li>
                <li style={{ marginBottom: '1rem' }}><Link href="/nri-investment" style={{ color: 'var(--color-text)', textDecoration: 'none' }}>NRI Investment Metrics</Link></li>
              </ul>
      ...
      {/* Strategic Competitor Analysis Section */}
      <section className="py-5" style={{ background: 'var(--color-surface)' }}>
          <div className="container">
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-5 mb-5 mb-lg-0">
              <h2 className="display-5 fw-bold mb-4" style={{ color: 'var(--color-text)' }}>Financial Planning & EMI Estimator</h2>
              <p style={{ color: 'var(--color-text-muted)', fontSize: '1.1rem', marginBottom: '2rem' }}>
                Analyze the staggering growth potential of the Baner-Pashan corridor. Use our interactive calculator to estimate your monthly cash flow requirements instantly.
              </p>
              <ul className="list-unstyled" style={{ color: 'var(--color-text)' }}>
                ...
                <li className="mb-3 d-flex align-items-center"><span className="material-symbols-outlined me-2" style={{ color: 'var(--color-primary)' }}>check_circle</span> 8-12% Average Annual Appreciation</li>
              </ul>
            </div>
